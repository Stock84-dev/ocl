...
#![doc(html_root_url = "https://docs.rs/ocl/0.19.3")]
...
pub use self::standard::{
    ArgIdxSpecifier, ArgValConverter, ArgValKeeper, Buffer, BufferCmdError, Context, Device, Event,
    EventArray, EventList, Extensions, Image, Kernel, Platform, ProQue, Program, Queue, Sampler,
    SpatialDims,
};
#[doc(no_inline)]
...
pub mod prm {
    ...
    pub use crate::ffi::{
        cl_GLenum, cl_GLint, cl_GLuint, cl_bitfield, cl_bool, cl_char, cl_double, cl_float,
        cl_half, cl_int, cl_long, cl_short, cl_uchar, cl_uint, cl_ulong, cl_ushort,
    };
}
...
pub mod builders {
    ...
    pub use crate::standard::{
        ...
        BufferWriteCmd, BuildOpt, ClNullEventPtrEnum, ClWaitListPtrEnum, ContextBuilder,
        DeviceSpecifier, ImageBuilder, ImageCmd, ImageCmdKind, KernelBuilder, KernelCmd,
        ProQueBuilder, ProgramBuilder,
    };
...
pub mod flags {
    ...
    pub use crate::core::{
        CommandQueueProperties, DeviceAffinityDomain, DeviceExecCapabilities, DeviceFpConfig,
        DeviceType, KernelArgTypeQualifier, MapFlags, MemFlags, MemMigrationFlags,
        ProgramBinaryType, DEVICE_AFFINITY_DOMAIN_L1_CACHE, DEVICE_AFFINITY_DOMAIN_L2_CACHE,
        DEVICE_AFFINITY_DOMAIN_L3_CACHE, DEVICE_AFFINITY_DOMAIN_L4_CACHE,
        ...
        FP_CORRECTLY_ROUNDED_DIVIDE_SQRT, FP_DENORM, FP_FMA, FP_INF_NAN, FP_ROUND_TO_INF,
        FP_ROUND_TO_NEAREST, FP_ROUND_TO_ZERO, FP_SOFT_FLOAT, KERNEL_ARG_TYPE_CONST,
        KERNEL_ARG_TYPE_NONE, KERNEL_ARG_TYPE_RESTRICT, KERNEL_ARG_TYPE_VOLATILE, MAP_READ,
        MAP_WRITE, MAP_WRITE_INVALIDATE_REGION, MEM_ALLOC_HOST_PTR, MEM_COPY_HOST_PTR,
        MEM_HOST_NO_ACCESS, MEM_HOST_READ_ONLY, MEM_HOST_WRITE_ONLY, MEM_READ_ONLY, MEM_READ_WRITE,
        MEM_USE_HOST_PTR, MEM_WRITE_ONLY, MIGRATE_MEM_OBJECT_CONTENT_UNDEFINED,
        MIGRATE_MEM_OBJECT_HOST, PROGRAM_BINARY_TYPE_COMPILED_OBJECT,
        PROGRAM_BINARY_TYPE_EXECUTABLE, PROGRAM_BINARY_TYPE_LIBRARY, PROGRAM_BINARY_TYPE_NONE,
